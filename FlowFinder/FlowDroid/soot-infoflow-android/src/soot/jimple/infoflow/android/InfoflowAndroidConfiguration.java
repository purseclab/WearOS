...
public class InfoflowAndroidConfiguration extends InfoflowConfiguration {
	...
	/**
	 * The configuration for the wearable analysis
	 * 
	 *
	 */

	public static class WearConfiguration {
		private boolean onlyFlowAnalysis = false;
		private boolean StringAnalysis = false;
		private String stringConfigFile = "";
		private String statisticPath = "";

		public void setOnlyFlowAnalysis(boolean value) {
			this.onlyFlowAnalysis = value;
		}

		public boolean getOnlyFlowAnalysis() {
			return this.onlyFlowAnalysis;
		}

		public void merge(WearConfiguration wearConfig) {
			this.onlyFlowAnalysis = wearConfig.onlyFlowAnalysis;
			this.StringAnalysis = wearConfig.StringAnalysis;
			this.stringConfigFile = wearConfig.stringConfigFile;
			this.statisticPath = wearConfig.statisticPath;
		}

		public boolean getStringAnalysis() {
		...
		public String getStringConfigFile() {
			return stringConfigFile;
		}

		public void setStringConfigFile(String stringConfigFile) {
			this.stringConfigFile = stringConfigFile;
		}
	...
	private final WearConfiguration wearAnalysisConfig = new WearConfiguration();
	...
	public void merge(InfoflowConfiguration config) {
		...
		if (config instanceof InfoflowAndroidConfiguration) {
			...
			this.wearAnalysisConfig.merge(androidConfig.wearAnalysisConfig);
	...
	public WearConfiguration getWearConfiguration() {
		return wearAnalysisConfig;
	}
