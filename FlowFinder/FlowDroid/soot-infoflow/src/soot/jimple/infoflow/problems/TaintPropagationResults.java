...
public class TaintPropagationResults {
	...
	protected static final Logger logger = LoggerFactory.getLogger(TaintPropagationResults.class);
	...
	public boolean addResult(AbstractionAtSink resultAbs) {
		...
		if (manager.getConfig().getIgnoreFlowsInSystemPackages() && SystemClassHandler.isClassInSystemPackage(
			...
			return true;
		// logger.info("ADDDING RESULT: " +resultAbs.toString());
		...
		// logger.info("ADDDING RESULT V2: " +resultAbs.toString());
